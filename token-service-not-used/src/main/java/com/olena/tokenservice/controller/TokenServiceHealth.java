...
import com.olena.tokenservice.config.TokenServiceProperties;
...
@Slf4j
@RestController
public class TokenServiceHealth {
    ...
    public ResponseEntity<String> checkHealth() {
        ...
        return new ResponseEntity<>("Welcome to Potluck Planner Token Service", HttpStatus.OK);
    }

    @GetMapping(value = "/version", produces = MediaType.TEXT_PLAIN_VALUE)
    public String checkVersion() {
        log.debug("checkVersion, entered");
        return "App version: " + tokenServiceProperties.getAppVersion();
    }
