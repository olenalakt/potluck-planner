...
import com.olena.drinkservice.service.InitKafkaPropertiesService;
...
public class KafkaSpringConfig {
    ...
    public Producer<String, DrinkMessage> startPotluckEventProducer(Properties producerProperties) {
//        producerProperties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, kafkaProperties.getValueSerializerCLass());
        ...
        return new KafkaProducer<String, DrinkMessage>(producerProperties);
    }
